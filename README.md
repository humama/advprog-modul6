...
Selanjutnya, kita menggunakan `format!` untuk menambahkan konten file sebagai isi respons sukses. Untuk memastikan respons HTTP valid, kami menambahkan header Content-Length yang disetel ke ukuran isi respons kami, dalam hal ini ukuran `hello.html`.
